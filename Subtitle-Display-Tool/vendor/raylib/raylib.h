...
#define rlLIGHTGRAY  CLITERAL(Color){ 200, 200, 200, 255 }   // Light Gray
#define rlGRAY       CLITERAL(Color){ 130, 130, 130, 255 }   // Gray
#define rlDARKGRAY   CLITERAL(Color){ 80, 80, 80, 255 }      // Dark Gray
#define rlYELLOW     CLITERAL(Color){ 253, 249, 0, 255 }     // Yellow
#define rlGOLD       CLITERAL(Color){ 255, 203, 0, 255 }     // Gold
#define rlORANGE     CLITERAL(Color){ 255, 161, 0, 255 }     // Orange
#define rlPINK       CLITERAL(Color){ 255, 109, 194, 255 }   // Pink
#define rlRED        CLITERAL(Color){ 230, 41, 55, 255 }     // Red
#define rlMAROON     CLITERAL(Color){ 190, 33, 55, 255 }     // Maroon
#define rlGREEN      CLITERAL(Color){ 0, 228, 48, 255 }      // Green
#define rlLIME       CLITERAL(Color){ 0, 158, 47, 255 }      // Lime
#define rlDARKGREEN  CLITERAL(Color){ 0, 117, 44, 255 }      // Dark Green
#define rlSKYBLUE    CLITERAL(Color){ 102, 191, 255, 255 }   // Sky Blue
#define rlBLUE       CLITERAL(Color){ 0, 121, 241, 255 }     // Blue
#define rlDARKBLUE   CLITERAL(Color){ 0, 82, 172, 255 }      // Dark Blue
#define rlPURPLE     CLITERAL(Color){ 200, 122, 255, 255 }   // Purple
#define rlVIOLET     CLITERAL(Color){ 135, 60, 190, 255 }    // Violet
#define rlDARKPURPLE CLITERAL(Color){ 112, 31, 126, 255 }    // Dark Purple
#define rlBEIGE      CLITERAL(Color){ 211, 176, 131, 255 }   // Beige
#define rlBROWN      CLITERAL(Color){ 127, 106, 79, 255 }    // Brown
#define rlDARKBROWN  CLITERAL(Color){ 76, 63, 47, 255 }      // Dark Brown

#define rlWHITE      CLITERAL(Color){ 255, 255, 255, 255 }   // White
#define rlBLACK      CLITERAL(Color){ 0, 0, 0, 255 }         // Black
#define rlBLANK      CLITERAL(Color){ 0, 0, 0, 0 }           // Blank (Transparent)
#define rlMAGENTA    CLITERAL(Color){ 255, 0, 255, 255 }     // Magenta
#define rlRAYWHITE   CLITERAL(Color){ 245, 245, 245, 255 }   // My own White (raylib logo)
